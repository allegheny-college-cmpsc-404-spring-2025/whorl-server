...
from logrotate import GzipTimedRotatingFileHandler
...
handler = GzipTimedRotatingFileHandler(f"{LOGS_DIR}/debug.log", when = 'S', interval = 5, backupCount = 5)
logger = logging.getLogger(__name__)
logger.addHanlder(handler)
